...
\begin{figure}
	...
	\end{subfigure}
	\end{center}
	\caption{Time evolution of perturbation of out-of-phase breather, showing amplitude of the peaks of $u_L$ and $u_R$ vs. $t$ (a), and difference in this amplitude from the unperturbed breather (b). Coupling parameter $d=0.25$, separation distance $N_1 = 4$.}
